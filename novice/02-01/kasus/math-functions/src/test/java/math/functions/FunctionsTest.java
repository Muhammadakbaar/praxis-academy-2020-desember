...
public class FunctionsTest {
    ...
    public void testAbsFunction(){
        Function<Integer, Integer> absFunction = integerFunctionMap.getFunction("absolute");
    ...
    public void testSignFunctionOnNegativeValue(){
        Function<Integer, Integer> signFunction = integerFunctionMap.getFunction("signum");
